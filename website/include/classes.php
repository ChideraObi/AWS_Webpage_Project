...
*/
    ...
    public function auditlog($context, $message, $priority = 0, $userid = NULL){
        ...
        //  $dbh = $this->getConnection();
          ...
          $url = "https://bvxzzvwzvb.execute-api.us-east-1.amazonaws.com/default/auditLog";
  			$data = array(
  				'context'=>$context,
  				'message'=>$message,
  				'logdate'=>$logdate,
  			...
  			curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json','x-api-key: A9o9FAyVxaa8iyG8ORTuQhtnoT0j8zW5bsoa54Pi','Content-Length: ' . strlen($data_json)));
    ...
    protected function sendValidationEmail($userid, $email, &$errors) {
        ...
        if ($result === FALSE) {
            ...
            $message = "A request has been made to create an account at Feed Me (http://34.196.106.138/webapp/website/index.php) for this email address. ".
            ...
            $headers = 'From: webmaster@feed.me' . "\r\n" .
                'Reply-To: webmaster@feed.me' . "\r\n";
...
/* keeps breaking site :(
    public function getUserRegistrations($userid, &$errors) {
 		...
 		$url = "https://yquazg6kt9.execute-api.us-east-1.amazonaws.com/default/getUserregistration?userid=" . $userid;
 		$ch = curl_init();
 		curl_setopt($ch, CURLOPT_URL, $url);
...
*/
    ...
    // Logs out the current user based on session ID
     ...
     $url = "https://ql2l3quj21.execute-api.us-east-1.amazonaws.com/default/Logout?usersessionid=$sessionid";
     $data = array(
     ...
     $ch = curl_init();
     curl_setopt($ch, CURLOPT_URL, $url);
     curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json','Content-Length: ' . strlen($data_json), 'x-api-key: A9o9FAyVxaa8iyG8ORTuQhtnoT0j8zW5bsoa54Pi'));
...
/*
    public function getThings(&$errors) {
       ...
       $url = "https://o6ywntpfo4.execute-api.us-east-1.amazonaws.com/default/getThings?thingregistrationcode=$registrationcode";
       $ch = curl_init();
       curl_setopt($ch, CURLOPT_URL, $url);
           curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json','Content-Length: ' . strlen($data_json), 'x-api-key:  A9o9FAyVxaa8iyG8ORTuQhtnoT0j8zW5bsoa54Pi'));
       curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
